...
const Signup = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await axios.post(`${apiUrl}/api/auth/signup`, formState);
  ...
  return (
    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', minHeight: '100vh', background: '#f8fafc', padding: '20px' }}>
      ...
      <div className="auth-form-card">
        <h2 style={{ textAlign: 'center', color: '#1b5e20', margin: '0 0 24px', fontSize: '1.8rem', fontWeight: 700 }}>Create Account</h2>
        ...
        <form onSubmit={handleSubmit} noValidate>
          ...
          <div className="form-group">
            ...
            <input 
              ...
              autoComplete="off"
              spellCheck="false"
              placeholder="Enter your email (e.g. farmer@gmail.com)"
            />
